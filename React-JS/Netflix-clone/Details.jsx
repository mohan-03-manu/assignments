...
export default function Details(){
    ...
    return(
        ...
        <div className="relative w-full h-[80vh] overflow-hidden">
          <ReactPlayer width="100vw" height="80vh" className="scale-[1.50]" loop={true} muted={volume} playing={true} src={movie.youtube_trailer} />
           <div className="absolute left-24 top-52 w-[400px] ">
             <div className="bg-orange-700 inline-block text-white px-4 py-1 rounded text-xs">IMDB Ratings {movie.imdb_rating}</div>
             <h1 className="text-white text-5xl font-black">{movie.title}</h1>
