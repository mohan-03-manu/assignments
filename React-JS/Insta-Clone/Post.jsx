...
export default function Post(){
    ...
    <div className="w-[560px] mx-auto  my-12">
        <div className="flex gap-4 items-center mb-2">
            ...
            <div>
                <p className="font-bold mb-0">{user.name}</p>
                <p className="text-sm m-0 text-neutral-600">{user.profession}</p>
            </div>
        </div>
           <img className="rounded-md" src={post.img} alt="" />
        ...
        <p>{(new Date(post.postedDate)).toLocaleDateString('en',options)}</p>
    </div>
